 ...
 */
typedef void (*nfc_tag_cb_t)(const struct device *dev,
...
typedef int (*nfc_tag_set_type_t)(const struct device *dev,
                                  enum nfc_tag_type type);

typedef int (*nfc_tag_get_type_t)(const struct device *dev,
                                  enum nfc_tag_type *type);
...
typedef int (*nfc_tag_set_ndef_t)(const struct device *dev,
                                  uint8_t *buf, uint16_t len);

typedef int (*nfc_tag_cmd_t)(const struct device *dev, enum nfc_tag_cmd cmd,
 ...
 * @return         : 0 on success, negative upon error.
 */
static inline int nfc_tag_set_type(const struct device *dev,
                                   enum nfc_tag_type type)
{
    const struct nfc_tag_driver_api *api = (const struct nfc_tag_driver_api *) dev->api;
 ...
 * @return         : 0 on success, negative upon error.
 */
static inline int nfc_tag_get_type(const struct device *dev,
                                   enum nfc_tag_type *type)
{
    const struct nfc_tag_driver_api *api = (const struct nfc_tag_driver_api *) dev->api;
 ...
 * @return             : 0 on success, negative upon error.
 */
static inline int nfc_tag_set_ndef(const struct device *dev,
                                   uint8_t *buf, uint16_t buf_len)
{
    const struct nfc_tag_driver_api *api = (const struct nfc_tag_driver_api *) dev->api;
 ...
 * @return                 : 0 on success, negative upon error.
 */
static inline int nfc_tag_cmd(const struct device *dev,
