...
#ifndef __NT3H2X11_H_
#define __NT3H2X11_H_
...
/* SECTOR1 only available if CONFIG_NT3H2X11_2K */
...
struct __attribute__((packed)) nt3h2x11_cc {
    uint8_t magic;
    uint8_t version;
    uint8_t size;
    uint8_t access;
...
struct __attribute__((packed)) nt3h2x11_device {
...
struct __attribute__((packed)) nt3h2x11_cfg_auth {
...
#define NT3H2X11_DEFAULT_DEVICE_ADDR            {0x04u}
#define NT3H2X11_DEFAULT_DEVICE_SERIAL          {0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u}
#define NT3H2X11_DEFAULT_DEVICE_INTERNAL        {0x00u, 0x00u, 0x00u}
#define NT3H2X11_DEFAULT_DEVICE_STATIC_LOCK     {0x00u, 0x00u}

#define NT3H2X11_DEFAULT_CFG_AUTH_DYN_LOCK      {0x00u, 0x00u, 0x00u}
#define NT3H2X11_DEFAULT_CFG_AUTH_AUTH0         {0xFFu}
#define NT3H2X11_DEFAULT_CFG_AUTH_ACCESS        {0x00u}
#define NT3H2X11_DEFAULT_CFG_AUTH_PWD           {0xFFu, 0xFFu, 0xFFu, 0xFFu}
#define NT3H2X11_DEFAULT_CFG_AUTH_PACK          {0x00u, 0x00u}
#define NT3H2X11_DEFAULT_CFG_AUTH_PT_I2C        {0x00u}

#define NT3H2X11_DEFAULT_CC         { NT3H2X11_DEFAULT_CC_MAGIC,            \
                                      NT3H2X11_DEFAULT_CC_VERSION,          \
                                      NT3H2X11_DEFAULT_CC_SIZE,             \
                                      NT3H2X11_DEFAULT_CC_ACCESS }

#define NT3H2X11_DEFAULT_DEVICE     { NT3H2X11_DEFAULT_DEVICE_ADDR,         \
                                      NT3H2X11_DEFAULT_DEVICE_SERIAL,       \
                                      NT3H2X11_DEFAULT_DEVICE_INTERNAL,     \
                                      NT3H2X11_DEFAULT_DEVICE_STATIC_LOCK,  \
                                      NT3H2X11_DEFAULT_CC }

#define NT3H2X11_DEFAULT_CFG_AUTH   { NT3H2X11_DEFAULT_CFG_AUTH_DYN_LOCK,   \
                                      NT3H2X11_DEFAULT_CFG_AUTH_AUTH0,      \
                                      NT3H2X11_DEFAULT_CFG_AUTH_ACCESS,     \
                                      NT3H2X11_DEFAULT_CFG_AUTH_PWD,        \
 ...
 */
typedef void (*nt3h2x11_irq_callback_t)(const struct device *dev,
 ...
 */
int nt3h2x11_set_device(const struct device *dev,
                        struct nt3h2x11_device *device);
 ...
 * @return            : 0 on success, negative upon error.
 */
int nt3h2x11_get_device(const struct device *dev,
                        struct nt3h2x11_device *device);
